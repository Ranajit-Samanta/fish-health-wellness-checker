...
with col2:
    ...
    st.write(
        "<h6 style='color: black;'>The Feed Conversion Ratio (FCR) is a key measure in aquaculture that indicates the efficiency of feed utilization by fish. It is calculated as the amount of feed consumed divided by the weight gain of the fish. A lower FCR signifies better feed efficiency, reducing costs and minimizing environmental impact, while a higher FCR suggests inefficiencies in diet or culture conditions. Optimizing FCR is crucial for sustainable and profitable aquaculture practices.</h6>",
        unsafe_allow_html=True,
    )
    st.image("WhatsApp Image 2025-02-27 at 10.48.46 PM.jpeg",width=260)
    st.image("WhatsApp Image 2025-02-27 at 10.54.57 PM.jpeg",width=260)
...
with col1:
    ...
    st.write(
        "<h5 style='color: black;'>Fish behaviour in different aquatic zones can be metaphorically compared to human nature:</h5>",
        unsafe_allow_html=True,
    )
    st.write(
...
with col2:
   ...
   st.video("short-Blue Economy (1).mp4") 
